...
const PremiumNav: FC<Props> = ({ children, title, hideScrolling }) => {
  ...
  return (
    ...
    >
      <div className="flex h-[var(--nav-h)] w-full items-center justify-between gap-2 bg-white/100  backdrop-blur-sm dark:border-slate-400/20 dark:bg-black/100 dark:shadow-cyan-100/10 xs:gap-4 ">
