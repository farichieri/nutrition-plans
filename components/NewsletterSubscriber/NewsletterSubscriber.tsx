...
const NewsletterSubscriber: FC<Props> = () => {
  ...
  return (
    <section className="flex mx-2 box-shadow-full w-fit flex-col items-center justify-center gap-5 rounded-2xl border border-green-500/50 bg-green-200 px-4 py-8 dark:bg-green-900 ">
