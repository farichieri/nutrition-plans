...
const PricingPlan: FC<Props> = ({ pricingPlan }) => {
  ...
  return (
    <div
      ...
      className="flex min-h-[27rem] w-full max-w-xs select-none flex-col items-center gap-5 rounded-3xl border border-green-400/20 bg-white px-5 py-10 shadow-[0_3px_20px] shadow-green-800/40 duration-300 dark:border-green-700/20 dark:bg-primary-color dark:hover:shadow-green-400/80"
    >
