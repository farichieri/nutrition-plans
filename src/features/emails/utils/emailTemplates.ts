const getMessageToNewsletterSubscriber = () => {
  const message = {
    ...
    <a href="https://nutritionplans.co" target="_blank">nutritionplans.co</a>
    `,
  };
  return message;
};
...
const getEmailToNewUser = (name: string) => {
  const message = {
    subject: "Welcome to nutritionplans.co!",
    html: `<p>Hi ${name},</p>
    <p>I'm Fabricio, Founder of <a href="https://nutritionplans.co" target="_blank">nutritionplans.co</a>. Just wanted to reach out and introduce myself.</p>
